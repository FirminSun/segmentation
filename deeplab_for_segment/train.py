...
parser.add_argument('--model_dir', type=str, default='./modelnew',
...
parser.add_argument('--data_dir', type=str, default='./datasetnew/',
...
parser.add_argument('--pre_trained_model', type=str, default='./models/resnet_v2_101.ckpt',
